...
<div class="content-wrapper" style="padding: 15px;">
    <h2 style="padding-bottom: 10px;">Especialistas </h2>
    <button class="btn btn-success" style="width: 100px; margin: 7px 0px;" data-bs-toggle="modal" data-bs-target="#cadastrarUsuario" onclick="abrirModal()"> + Novo</button>
    <div class="card">
        <table class="table">
            <thead>
                <tr>
    ...
    <div class="modal fade" id="cadastrarUsuario" tabindex="-1" aria-labelledby="cadastrarUsuario" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="cadastrarUsuario">Cadastrar Especialista</h1>
        ...
        ('$email', '$senha', '$perfilEspecialidade')";
                ...
                ?>
                <form id="cadastrarUsuarioForm" action="especialistas.php?acao=cadastrar" method="post" style="padding: 20px;">
